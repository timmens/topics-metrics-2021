...
def create_cross_covariance_plot(
    ...
    # create data
    data = _create_plot_data(kernels, locations, betas, n_grid_points)
...
def _create_plot_data(kernels, locations, betas, n_grid_points):
    ...
    values = {
        kernel: _compute_cross_var_path(grid, kernel, locations, betas)
